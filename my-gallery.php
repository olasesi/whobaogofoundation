...
<main>
  ...
  <section style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('/assets/images/about-hero-bg.jpg') center/cover; min-height: 320px; display: flex; align-items: center; justify-content: space-between; padding: 0 2rem; flex-wrap: wrap; gap: 1.5rem;">
    <div>
      <h1 style="font-size: clamp(2rem, 5vw, 3.5rem); font-weight: 800; color: #fff; line-height: 1.2;">Gallery</h1>
    </div>
    <div style="display: flex; align-items: center; gap: 0.75rem; background: rgba(224,53,53,0.9); padding: 0.8rem 1.5rem; border-radius: 100px;">
      ...
      <span style="color: rgba(255,255,255,0.8); font-size: 0.85rem; font-weight: 600; text-transform: uppercase;">GALLERY</span>
    </div>
  </section>
  ...
  <section class="gallery-section">
    <div class="wrap">
      <div class="gallery-header">
        ...
        <h2 class="section-title">Medical Outreach</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">Medical outreached to elderly people in Ihitte/Uboma Local Government Area of Imo State. Free Medical Treatment, Consultation, Blood Pressure and Sugar level was administered to the Community.</p>
      </div>
  ...
  <section class="gallery-section section-bg">
    <div class="wrap">
      <div class="gallery-header">
        <div class="section-subtitle">Our Work</div>
        <h2 class="section-title">Water Project</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">Rehabilitation of Ihitte/Uboma Community Water project. The Foundation renovated the abandoned water project which has been overgrown by thick grasses. The Foundation employed a facility manager and provided a power generator to ensure steady water supply to the Community.</p>
      </div>
      <div class="carousel-container">
  ...
  <section class="gallery-section">
    <div class="wrap">
      <div class="gallery-header">
        <div class="section-subtitle">Education Support</div>
        <h2 class="section-title">2020 Registration Of SSCE</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">Registration of SS3 students of Nwaeruru Mbakwe Comprehensive School in Ihitte/Uboma Local Government Area of Imo State for SSCE Examination by Whoba Ogo Foundation graced by the Royal Highness Eze Umuihi, Imo State.</p>
      </div>
      <div class="carousel-container">
  ...
  <section class="gallery-section section-bg">
    <div class="wrap">
      <div class="gallery-header">
        <div class="section-subtitle">Education Support</div>
        <h2 class="section-title">2021 Registration Of SSCE</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">71 students from Nwaeruru Mbakwe Comprehensive School in Ihitte/Uboma Local Government Area of Imo State were registered for SSCE.</p>
      </div>
      <div class="carousel-container">
  ...
  <section class="gallery-section">
    <div class="wrap">
      <div class="gallery-header">
        <div class="section-subtitle">Education Support</div>
        <h2 class="section-title">Visit Of Whoba Ogo Foundation To Nwaeruru-Mbakwe Comprehensive Secondary School</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">Before the arrival of the Whoba Ogo Foundation, the state of Nwaeruru Mbakwe Secondary School Ihitte/Uboma was a devastating one. Almost all building in the school is bad and at the verge of collapsing, roofs have fallen off, even when it rains, its pours directly on the students.</p>
      </div>
      <div class="carousel-container">
  ...
  <section class="gallery-section section-bg">
    <div class="wrap">
      <div class="gallery-header">
        <div class="section-subtitle">Education Support</div>
        <h2 class="section-title">Renovation Of Nwaeruru-Mbakwe Comprehensive Secondary School By Whoba Ogo Foundation</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">After the visit of Whoba Ogo Foundation, new infrastructure was built, library, classroom, chairs were provided for all the students in different classes, staffrooms, students and teachers' restroom, students' hostels.</p>
      </div>
      <div class="carousel-container">
  ...
  <section class="gallery-section">
    <div class="wrap">
      <div class="gallery-header">
        <div class="section-subtitle">Education Support</div>
        <h2 class="section-title">The New Face Of Nwaeruru Mbakwe Comprehensive School</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">The new Face of Nwaeruru-Mbakwe comprehensive secondary school Umuihi Ihite/Uboma Local Government Area of Imo State, after the total renovation of infrastructure by Whoba Ogo Foundation.</p>
      </div>
      <div class="carousel-container">
  ...
  <section class="gallery-section section-bg">
    <div class="wrap">
      <div class="gallery-header">
        <div class="section-subtitle">Community Support</div>
        <h2 class="section-title">Widow's Mite</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">Widows in Ihitte/Uboma Local Government Area of Imo State receiving Financial Support from Whoba Ogo Foundation.</p>
      </div>
      <div class="carousel-container">
  ...
  <section class="gallery-section">
    <div class="wrap">
      <div class="gallery-header">
        ...
        <h2 class="section-title">Empowerment of Cobblers</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">The Whoba Ogo Foundation empowered 10 idle but skilled cobblers with all the materials needed to start their business including renting of shops for them in Isinweke Market.</p>
      </div>
      <div class="carousel-container">
  ...
  <section class="gallery-section section-bg">
    <div class="wrap">
      <div class="gallery-header">
        <div class="section-subtitle">Community Support</div>
        <h2 class="section-title">Church Project</h2>
        <p style="color: var(--gray); line-height: 1.8; max-width: 900px; margin: 0 auto;">Renovation of Church by Whoba Ogo Foundation in Ihitte/Uboma Local Government Area of Imo State.</p>
      </div>
      <div class="carousel-container">
